<%-- 
    Document   : FlujoCaja
    Created on : 1/12/2016, 11:27:56 AM
    Author     : mayrayesenia
--%>
                            ...
                            <div  id="areaImp">
                                <div class="row">
                                    <div class="col-md-6 col-xs-5" align="right">
                                        <br><img src="../img/Mis_Iconos/flujo_caja.png" alt="" class="dos"/>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <th colspan="6" class="info"><div class="text-center">Flujo de Caja Operativo</div></th>
                                    </tr>
                                    <tr>
                                        <td title="La utilidad operacional se refiere única y exclusivamente a los ingresos y gastos operacionales, dejando de lado los gastos e ingresos no operacionales 
                                            (Utilidad Bruta-(Gasto de Ventas + Gastos de Administracion + Provisiones + Amortización Gastos))">Utilidad Operacional</td>
                                    ...
                                    <tr>
                                        <td title="Disminución del valor de un bien material (suma de Depreciación Período de 
                                            (Construcciones y Edificios + Maquinaria y Equipo + Muebles y Enseres + Equipo de Transporte + Equipo de Oficina) )">Depreciaciones</td>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="text-right">$ <%=formato.format((idDAO.total(idp) / 5))%></div></td>
                                        <td><div class="text-right">$ <%=formato.format((idDAO.total(idp) / 5))%></div></td>
                                        <td><div class="text-right">$ <%=formato.format((idDAO.total(idp) / 5))%></div></td>
                                        <td><div class="text-right">$ <%=formato.format((idDAO.total(idp) / 5))%></div></td>
                                        <td><div class="text-right">$ <%=formato.format((idDAO.total(idp) / 5))%></div></td>
                                    ...
                                    <tr>
                                        <td title="Cuentas impagables o dificil cobro por tanto constituyen un gasto para la empresa">Provisiones</td>
                                    ...
                                    --%>
                                    <tr class="warning">
                                        <td title="cantidad de dinero en efectivo que genera una empresa a través de sus operaciones y el ejercicio de su actividad 
                                            (Utilidad Operacional + Depreciaciones + Amortización Gastos + Agotamiento + Provisiones)">Neto Flujo de Caja Operativo</td>
                                        <td><div class="text-right">$ <%=formato.format(flujooperativo)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(flujooperativo2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(flujooperativo3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(flujooperativo4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(flujooperativo5)%></div></td>
                                    </tr>
                                    <tr>
                                        <th colspan="6" class="info"><div class="text-center">Flujo de Caja Inversión</div></th>
                                    </tr>
                                    <%--
                                    <tr>
                                        <td>Variacion Cuentas por Cobrar</td>
                                    ...
                                    <tr>
                                        <td>Variacion Inv. Materias Primas e insumos</td>
                                    ...
                                    <tr>
                                        <td>Variacion Inv. Prod. En Proceso</td>
                                    ...
                                    <tr>
                                        <td>Variacion Inv. Prod. Terminados</td>
                                    ...
                                    <tr>
                                        <td>Var. Anticipos y Otros Cuentas por Cobrar</td>
                                        <td><div class="text-right">$ <%=formato.format(0-anticipo)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(anticipo - anticipo2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(anticipo2 - anticipo3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(anticipo3 - anticipo4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(anticipo4 - anticipo5)%></div></td>
                                    </tr>

                                    <tr>
                                        <td>Variación Cuentas por Pagar</td>
                                    ...
                                    <tr>
                                        <td>Variación Acreedores Varios</td>
                                    ...
                                    --%>
                                    <tr>
                                        <td title="Variación de recursos corrientes que tiene la empresa para desarrollar
                                            sus operaciones en distintos momentos ya determinados">Variación del Capital de Trabajo</td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion + otrosActivos)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion2 + otrosActivos2 - otrosActivos)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion3 + otrosActivos3 - otrosActivos2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion4 + otrosActivos4 - otrosActivos3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion5 + otrosActivos5 - otrosActivos4)%></div></td>
                                    </tr>
                                    <tr>
                                        <td title="Variación de Otros activos">Inversión Activos Fijos</td>
                                        <td><div class="text-right">$ <%=formato.format(0-otrosActivos)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(otrosActivos2 - otrosActivos)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(otrosActivos3 - otrosActivos2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(otrosActivos4 - otrosActivos3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(otrosActivos5 - otrosActivos4)%></div></td>
                                    </tr>
                                    <tr class="warning">
                                        <td title="La variación de capital procedente de la diferencia entre las entradas y salidas de efectivo procedentes de inversiones en instrumentos financieros
                                             (Variación del Capital de Trabajo + Inversión Activos Fijos)">Neto Flujo de Caja Inversión</td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajadeinversion5)%></div></td>
                                    </tr>
                                    <tr class="info">
                                        <th colspan="6"><div class="text-center">Flujo de Caja Financiamiento</div></th>
                                    </tr>
                                    <tr>
                                        <td title="Reembolso del dinero otorgado en un plazo convenido">Amortizaciones Pasivos Largo Plazo</td>
                                        <td><div class="text-right">$ <%=formato.format(0-amortizacion)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-insobresal2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-insobresal3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-insobresal4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-insobresal5)%></div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td title="El dividendo es la parte del beneficio de una empresa
                                            que ésta decide repartir entre sus accionistas">Dividendos Pagados</td>
                                        <td><div class="text-right">$ <%=formato.format(0)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-dividendo)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-dividendo2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-dividendo3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(0-dividendo4)%></div></td>
                                    </tr>
                                    <tr>
                                        <td title="Valor inicial de aportes de socios,
                                            Fuentes de financiación(Donación+ Propios + Municipio + Departamento + Otro)">Capital</td>
                                        <td><div class="text-right">$ <%=formato.format(capitalAdicionalSocios)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(capitalAdicionalSocios2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(capitalAdicionalSocios3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(capitalAdicionalSocios4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(capitalAdicionalSocios5)%></div></td>
                                    </tr>
                                    <tr class="warning">
                                        <td title="Amortizaciones Pasivos Largo Plazo + Intereses Pagados + Dividendos Pagados + Capital">Neto Flujo de Caja Financiamiento</td>
                                        <td><div class="text-right">$ <%=formato.format(cajafinanciamiento)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajafinanciamiento2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajafinanciamiento3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajafinanciamiento4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(cajafinanciamiento5)%></div></td>
                                    </tr>
                                    <tr>
                                        <td colspan="6"></td>
                                    ...
                                    <tr>
                                        <td>Neto Periodo</td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO2)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO3)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO4)%></div></td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO5)%></div></td>
                                    </tr>
                                    <tr>
                                        <td>Saldo anterior</td>
                                        <td><div class="text-right">$ <%=formato.format(EFECTIVO0)%></div></td>
